  ...
  async processMessage({ sessionId, memberId, content, context = {} }) {
    ...
    try {
      ...
      try {
        ...
        intent = { intent_type: 'show_schedule', confidence: 0.3, entities: {}, original_query: content, error: String(e?.message || e) };
      }
      ...
      try {
        ...
        aiResponse = {
          ...
          metadata: { error: String(e?.message || e), engine: 'tm-ai' },
          entities: {},
        };
      }
